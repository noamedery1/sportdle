/* ============================================================
   בית"ר ירושלים — שאיבת סגלים מ-worldfootball
   ============================================================
   1. פתח בדפדפן שלך:  https://www.worldfootball.net/teams/te214/beitar-jerusalem/squad/
   ...
   4. בסוף יורד הקובץ  beitar-worldfootball.json
      שים אותו ב-  data/raw/beitar-worldfootball.json
      והרץ:        node scripts/enrich.mjs && node scripts/build.mjs
   ============================================================ */
var stop = false;
(async () => {
  const TEAM = "te214/beitar-jerusalem";
  const SLUG = "beitar";
