/* ============================================================
   מכבי תל אביב — שאיבת סגלים מ-worldfootball
   ============================================================
   1. פתח בדפדפן שלך:  https://www.worldfootball.net/teams/te1258/maccabi-tel-aviv/squad/
   ...
   4. בסוף יורד הקובץ  maccabi-ta-worldfootball.json
      שים אותו ב-  data/raw/maccabi-ta-worldfootball.json
      והרץ:        node scripts/enrich.mjs && node scripts/build.mjs
   ============================================================ */
var stop = false;
(async () => {
  const TEAM = "te1258/maccabi-tel-aviv";
  const SLUG = "maccabi-ta";
