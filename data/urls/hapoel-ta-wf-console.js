/* ============================================================
   הפועל תל אביב — שאיבת סגלים מ-worldfootball
   ============================================================
   1. פתח בדפדפן שלך:  https://www.worldfootball.net/teams/te956/hapoel-tel-aviv/squad/
   ...
   4. בסוף יורד הקובץ  hapoel-ta-worldfootball.json
      שים אותו ב-  data/raw/hapoel-ta-worldfootball.json
      והרץ:        node scripts/enrich.mjs && node scripts/build.mjs
   ============================================================ */
var stop = false;
(async () => {
  const TEAM = "te956/hapoel-tel-aviv";
  const SLUG = "hapoel-ta";
