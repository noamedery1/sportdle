/* ============================================================
   מכבי חיפה — שאיבת סגלים מ-worldfootball
   ============================================================
   1. פתח בדפדפן שלך:  https://www.worldfootball.net/teams/te1254/maccabi-haifa/squad/
   ...
   4. בסוף יורד הקובץ  maccabi-haifa-worldfootball.json
      שים אותו ב-  data/raw/maccabi-haifa-worldfootball.json
      והרץ:        node scripts/enrich.mjs && node scripts/build.mjs
   ============================================================ */
var stop = false;
(async () => {
  const TEAM = "te1254/maccabi-haifa";
  const SLUG = "maccabi-haifa";
